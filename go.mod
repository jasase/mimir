...
require (
	...
	github.com/grafana/dskit v0.0.0-20221027115736-8266e8838475
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v0.0.0-20221027174344-1c56b145565c
